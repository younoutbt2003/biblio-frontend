...
const recentReports = [
  {
    id: '1',
    title: 'Q4 2023 Team Performance',
    date: '2024-01-05',
    type: 'Quarterly',
    format: 'PDF',
    size: '2.4 MB'
...
export const TeamReport: React.FC = () => {
  ...
  return (
    <TeamLayout
      title="Team Report" 
      subtitle="Generate comprehensive reports for your team's research output"
    >
      {/* Stats Cards */}
      ...
      <div className="grid grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  { value: 'summary', label: 'Team Summary', desc: 'Overview of team metrics' },
                  { value: 'detailed', label: 'Detailed Analysis', desc: 'Full metrics and comparisons' }
                ].map((option) => (
                  <button
                    key={option.value}
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-4" style={{ height: '400px' }}>
