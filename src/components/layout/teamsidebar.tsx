...
const navigation = [
  ...
  { 
    ...
    items: [
      ...
      { name: 'Collaboration', href: '/team/collaboration', icon: Network },
      { name: 'AI Recommendations', href: '/team/ai-recommendations', icon: Sparkles },
    ]
  },
  { 
    section: 'Team Management',
    items: [
      { name: 'Manage Members', href: '/team/manage-members', icon: UserPlus },
      { name: 'Team Report', href: '/team/report', icon: FileBarChart },
      { name: 'Compare Teams', href: '/team/compare', icon: GitCompare },
    ]
  },
];
